...
#
# Generated Sun Oct 21 15:45:42 2012 by parse_xsd.py version 0.4.
#
...
class RequestType_(SamlBase):
    ...
    c_attributes['{http://schemas.xmlsoap.org/soap/envelope/}mustUnderstand'] = ('mustUnderstand', 'None', True)
...
class RelayStateType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_attributes['{http://schemas.xmlsoap.org/soap/envelope/}mustUnderstand'] = ('mustUnderstand', 'string', True)
