...
class PublicKeyType_(SamlBase):
    ...
    def __init__(self,
        ...
        self.key_validation="urn:oasis:names:tc:SAML:2.0:ac:classes:X509"
...
class GoverningAgreementsType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}GoverningAgreementRef'] = ('governing_agreement_ref', [GoverningAgreementRef])
...
class ActivationLimitType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}ActivationLimitDuration'] = ('activation_limit_duration', ActivationLimitDuration)
    c_cardinality['activation_limit_duration'] = {"min":0, "max":1}
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}ActivationLimitUsages'] = ('activation_limit_usages', ActivationLimitUsages)
    c_cardinality['activation_limit_usages'] = {"min":0, "max":1}
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}ActivationLimitSession'] = ('activation_limit_session', ActivationLimitSession)
...
class IdentificationType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}PhysicalVerification'] = ('physical_verification', PhysicalVerification)
    ...
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}GoverningAgreements'] = ('governing_agreements', GoverningAgreements)
...
class ActivationPinType_(SamlBase):
    ...
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}Generation'] = ('generation', Generation)
    c_cardinality['generation'] = {"min":0, "max":1}
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}ActivationLimit'] = ('activation_limit', ActivationLimit)
...
class PrincipalAuthenticationMechanismType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}RestrictedPassword'] = ('restricted_password', RestrictedPassword)
...
class OperationalProtectionType_(SamlBase):
    ...
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}DeactivationCallCenter'] = ('deactivation_call_center', DeactivationCallCenter)
...
class AuthnMethodBaseType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}PrincipalAuthenticationMechanism'] = ('principal_authentication_mechanism', PrincipalAuthenticationMechanism)
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}Authenticator'] = ('authenticator', Authenticator)
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}AuthenticatorTransportProtocol'] = ('authenticator_transport_protocol', AuthenticatorTransportProtocol)
...
class TechnicalProtectionBaseType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}PrivateKeyProtection'] = ('private_key_protection', PrivateKeyProtection)
    c_cardinality['private_key_protection'] = {"min":0, "max":1}
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}SecretKeyProtection'] = ('secret_key_protection', SecretKeyProtection)
...
class AuthnContextDeclarationBaseType_(SamlBase):
    ...
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}TechnicalProtection'] = ('technical_protection', TechnicalProtection)
    c_cardinality['technical_protection'] = {"min":0, "max":1}
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}OperationalProtection'] = ('operational_protection', OperationalProtection)
...
class ComplexAuthenticatorType_(SamlBase):
    ...
    c_child_order = SamlBase.c_child_order[:]
    c_cardinality = SamlBase.c_cardinality.copy()
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}PreviousSession'] = ('previous_session', PreviousSession)
    ...
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}SharedSecretChallengeResponse'] = ('shared_secret_challenge_response', SharedSecretChallengeResponse)
    c_cardinality['shared_secret_challenge_response'] = {"min":0, "max":1}
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}SharedSecretDynamicPlaintext'] = ('shared_secret_dynamic_plaintext', SharedSecretDynamicPlaintext)
    ...
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}AsymmetricDecryption'] = ('asymmetric_decryption', AsymmetricDecryption)
    c_cardinality['asymmetric_decryption'] = {"min":0, "max":1}
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}AsymmetricKeyAgreement'] = ('asymmetric_key_agreement', AsymmetricKeyAgreement)
    c_cardinality['asymmetric_key_agreement'] = {"min":0, "max":1}
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}SubscriberLineNumber'] = ('subscriber_line_number', SubscriberLineNumber)
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
ComplexAuthenticatorType_.c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}ComplexAuthenticator'] = ('complex_authenticator', ComplexAuthenticator)
ComplexAuthenticator.c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient}ComplexAuthenticator'] = ('complex_authenticator', ComplexAuthenticator)
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
