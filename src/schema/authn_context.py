...
class ActivationLimitDurationType_(SamlBase):
    """The urn:oasis:names:tc:SAML:2.0:ac:ActivationLimitDurationType element """
...
class SharedSecretChallengeResponseType_(SamlBase):
    """The urn:oasis:names:tc:SAML:2.0:ac:SharedSecretChallengeResponseType element """
...
class SharedSecretChallengeResponse(SharedSecretChallengeResponseType_):
    """The urn:oasis:names:tc:SAML:2.0:ac:SharedSecretChallengeResponse element """
...
class SharedSecretDynamicPlaintext(ExtensionOnlyType_):
    """The urn:oasis:names:tc:SAML:2.0:ac:SharedSecretDynamicPlaintext element """
...
class MobileNetworkRadioEncryption(ExtensionOnlyType_):
    """The urn:oasis:names:tc:SAML:2.0:ac:MobileNetworkRadioEncryption element """
...
class MobileNetworkEndToEndEncryption(ExtensionOnlyType_):
    """The urn:oasis:names:tc:SAML:2.0:ac:MobileNetworkEndToEndEncryption element """
...
class AuthenticatorTransportProtocolType_(SamlBase):
    """The urn:oasis:names:tc:SAML:2.0:ac:AuthenticatorTransportProtocolType element """
...
class AuthenticatorTransportProtocol(AuthenticatorTransportProtocolType_):
    """The urn:oasis:names:tc:SAML:2.0:ac:AuthenticatorTransportProtocol element """
...
class PrincipalAuthenticationMechanismType_(SamlBase):
    """The urn:oasis:names:tc:SAML:2.0:ac:PrincipalAuthenticationMechanismType element """
...
class PrincipalAuthenticationMechanism(PrincipalAuthenticationMechanismType_):
    """The urn:oasis:names:tc:SAML:2.0:ac:PrincipalAuthenticationMechanism element """
...
#..................
# ['AuthenticatorBaseType', 'AuthenticationContextDeclaration', 'ComplexAuthenticatorType', 'Authenticator', 'AuthnMethodBaseType', 'ComplexAuthenticator', 'AuthnMethod', 'AuthnContextDeclarationBaseType']
...
class AuthnContextDeclarationBaseType_(SamlBase):
    """The urn:oasis:names:tc:SAML:2.0:ac:AuthnContextDeclarationBaseType element """
...
class AuthenticationContextDeclaration(AuthnContextDeclarationBaseType_):
    """The urn:oasis:names:tc:SAML:2.0:ac:AuthenticationContextDeclaration element """
