...
class TestAC():
    ...
    def test_ava_fro_1(self):
        ...
        for ac in self.acs:
            try:
                ...
                pass
        print((list(ava.keys())))
        assert _eq(list(ava.keys()), ['givenName', 'displayName', 'uid',
    ...
    def test_ava_fro_2(self):
        ...
        print((list(ava.keys())))
        assert _eq(list(ava.keys()), ['eduPersonEntitlement', 'eduPersonAffiliation',
    ...
    def test_to_and_for(self):
        ...
        assert _eq(list(ava.keys()), list(oava.keys()))
